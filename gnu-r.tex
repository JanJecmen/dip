...
% tady z ty formuace neni jasny jestli base patri taky do searc path - pokud jo, tak default neni the lowest;-D
...
% tohle uplne nesouvisis tim ze R is not the fastest lang out there - naopak tim ze je pomaly by melo bejt snadny ho zrychlit. 
...
% taky (a mozna hlavne?) ten problem je v tom, ze vsehcny hodnoty jsou boxovany v R a to casto multiple levels (jakoze binding -> SEXP promise -> SEXP value -> actual data... Kdezto v C mas jeden integer;-D
