...
% zjistil bych kolik presne tech object systemu ma a napsal to tam, bez vykricniku
...
% mozna bych k tem aritmetickejm pridal ze i control flow sou funkce - to mi prijde vic sokujici nez ze + je funkce
...
% nejsem si uplne jistej jak myslis ze promises minimizujou sideeffecty... Mi prijde spis naopak;-DD. Vynechal bych to o ty C++ dereferencci, nechal bych jen the -> jako perlicku
...
% ... as well as objects are internally built on vectors and lists. 
...
% we haven't mentioned it - furt je tam ten vykricnik + myslim, ze tech object systemu ma vic, dal bych mozna but three widely used ... 
...
% zminil bych, ze to jesstli bude vysledek zobrazenej nebo ne je programmable a ne hardcoded...
...
% mozna spis nez unevaluated (protoze to by mohly bejt i promises) bych rekl ze take their argument as ASTs...
