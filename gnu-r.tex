...
\todo[cenv] \todo[assumptions] \todo[inlining during function call] \todo[call always expensive]
...
These assumptions, of course, do not necessarily hold all the time, as demonstrated in listing \ref{lst:break-plus}. Here, after changing the binding of \rinline/`+`/, the compiled function gives wrong result with no warning, since it inlined the addition and it does not get recompiled.
