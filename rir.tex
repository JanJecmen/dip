...
% mozna bych zminil ze ten interpreter je v C aby se jednou mohl stat soucasti GNU-R, kdezto statni muze bejt vzdycky balicek nekde ve footnote nebo tak. 
...
% tohle je sice pravda, ale o co jde v RIR hlavne je aby instrukce byly easy to reason about - napriklad MAKEPROM v R dela X ruznejch veci v zavislosti na tom, co je presne na stacku - tomu se hlavne chceme vyhnout...
...
% aha ty to pises tady - mozna bych vynechal ten call nahore a dal jen tohle - jakoze tohle je dulezity ten call je jen proste dusledek...
...
% timhle odstavcem (ten in genreal) bych to cely zacal - jakoze nejdriv in general a pak specificky priklady.  
